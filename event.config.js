...
window.EVENT = {
  ...
  /* How long a half-finished tag is kept, in minutes. It survives a reload
     ...
     app starts with a clean one.
       20    -- the setting here: long enough to come back to a half-finished
                tag, short enough that a device passed to the next person
                does not show them somebody else's
